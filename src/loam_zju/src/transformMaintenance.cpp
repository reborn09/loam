...
float transformMapped[6] = {0};    // the output final pose
float transformBefMapped[6] = {0}; // the pose before mapping
float transformAftMapped[6] = {0}; // the pose after mapping
...
//  std::cout<<"transformMapped: "<<transformMapped[0]<<" "<<transformMapped[1]<<" "<<transformMapped[2]<<" "
