...
PARAMETER_READER parameterReader("/root/catkin_SLAM/src/loam_cmu/parameters/laserMappingPara.txt");
...
//        std::cout << "laser mapping time: "<<(t_end.tv_sec - t_start.tv_sec)*1000.0
